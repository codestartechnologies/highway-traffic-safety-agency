        ...
        <tbody class="text-capitalize">
            ...
            ?>
                <tr>
                    ...
                    <td> <?php echo $post->{HTSA_PENALTY_VEHICLE_CATRGORIES_META_KEY}['bus_shuttle'] ?? null; ?> </td>
                    <td> <?php echo $post->{HTSA_PENALTY_VEHICLE_CATRGORIES_META_KEY}['mini_bus'] ?? null; ?> </td>
                    <td> <?php echo $post->{HTSA_PENALTY_VEHICLE_CATRGORIES_META_KEY}['luxury_bus'] ?? null; ?> </td>
                    <td> <?php echo $post->{HTSA_PENALTY_VEHICLE_CATRGORIES_META_KEY}['trailer'] ?? null; ?> </td>
                    <td> <?php echo $post->{HTSA_PENALTY_VEHICLE_CATRGORIES_META_KEY}['lorry'] ?? null; ?> </td>
                    <td> <?php echo $post->{HTSA_PENALTY_VEHICLE_CATRGORIES_META_KEY}['tricycle'] ?? null; ?> </td>
                    <td> <?php echo $post->{HTSA_PENALTY_VEHICLE_CATRGORIES_META_KEY}['motorcycle'] ?? null; ?> </td>
                </tr>
            <?php endwhile?>
        </tbody>
    </table>
