<?php
/**
 * HTSAContactPageCustomizer class file
 *
 * This is file contains HTSAContactPageCustomizer class for creating contact page customizer sections, settings and controls.
 *
...
if ( ! class_exists( 'HTSAContactPageCustomizer' ) ) {
    /**
     * HTSAContactPageCustomizer Class
     *
     ...
     * @author Chijindu Nzeako <chijindunzeako517@gmail.com>
     */
    final class HTSAContactPageCustomizer extends AbstractsCustomizer {
        /**
         * HTSAContactPageCustomizer constructor
         *
         * @access public
        ...
        {
            if ( ! is_string( $value ) || strlen( $value ) > 260 ) {
                $validity->add( 'htsa_customize', esc_html__( 'Value must be a string and not greater than 260 characters', 'htsa' ) );
            }
