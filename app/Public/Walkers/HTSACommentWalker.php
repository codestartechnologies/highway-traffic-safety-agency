...
if ( ! class_exists( 'HTSACommentWalker' ) ) {
    /**
     * Class HTSACommentWalker
     *
    ...
    final class HTSACommentWalker extends Walker_Comment {
        ...
        protected function html5_comment( $comment, $depth, $args ) {
            ...
            <<?php echo $tag; ?> id="comment-<?php comment_ID(); ?>" <?php comment_class( array( 'event', $this->has_children ? 'parent' : '' ), $comment ); ?>>
                ...
                <div class="content ms-0">
                    ...
                    <div class="summary">
                        <!-- <div class="comment-author vcard"> -->
                            ...
                            $text = ( $comment->comment_parent == 0 )
                                ? 'added a comment'
                                : sprintf(
                                    'replied to <a href="javascript:void(0);" class="text-capitalize">%s\'s</a> comment',
                                    get_comment_author( $comment->comment_parent )
                                );
                            printf(
                                '<a href="javascript:void(0);" class="text-capitalize">%1$s</a> %2$s',
                                $comment_author,
                                $text
                            );
                        ...
                        <div class="date">
                            ...
                            echo get_comment_date( 'F Y', $comment );
