...
if ( ! class_exists( 'HTSANavMenuWalker' ) ) {
    /**
    ...
    final class HTSANavMenuWalker extends Walker_Nav_Menu {
        ...
        public function start_lvl( &$output, $depth = 0, $args = null ) {
            ...
            if ( in_array( $args->theme_location, array( 'wts_mobile_menu', 'wts_pc_menu', ), true ) ) {
                $style = ( 1 === $depth && 'wts_mobile_menu' === $args->theme_location ) ? 'style="background-color: #dfe5e8;"' : null;
                $output .= "{$n}{$indent}<div$class_names $style>{$n}";
            } else {
